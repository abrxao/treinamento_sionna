on("ready", function () {
    ...
    function startBuild() {
        ...
        var minMaxCoords = elem("#minMaxCoords").value;
        if (minMaxCoords) {
            var minMaxCoordsArray = minMaxCoords.split(",");
            data.coords = [minMaxCoordsArray[0], minMaxCoordsArray[1], minMaxCoordsArray[2], minMaxCoordsArray[3]];
        }
